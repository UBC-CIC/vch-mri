...
\copy mri_rules(body_part, info, contrast, priority) FROM './csv/rules.csv' DELIMITER ',' CSV HEADER;
...
\copy word_weights FROM './csv/wordweights.csv' DELIMITER ',' CSV;

\copy spellchecker FROM './csv/spellchecker.csv' DELIMITER ',' CSV;

\copy specialty_tags FROM './csv/specialty_exams.csv' DELIMITER ',' CSV;
...
\copy conjunctions FROM './csv/conjunctions.csv' DELIMITER ',' CSV;
