            ...
            <Table celled compact sortable>
                <Table.Header fullWidth>
                    <Table.Row>
                        <Table.HeaderCell
                            collapsing
                            sorted={this.props.sortedColumn === 'active' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('active');}}
                        >Active</Table.HeaderCell>
                        <Table.HeaderCell
                            collapsing
                            sorted={this.props.sortedColumn === 'id' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('id');}}
                        >ID</Table.HeaderCell>
                        <Table.HeaderCell
                            collapsing
                            sorted={this.props.sortedColumn === 'body_part' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('body_part');}}
                        >Body Part</Table.HeaderCell>
                        <Table.HeaderCell
                            collapsing
                            sorted={this.props.sortedColumn === 'contrast' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('contrast');}}
                        >Contrast</Table.HeaderCell>
                        <Table.HeaderCell
                            collapsing
                            sorted={this.props.sortedColumn === 'priority' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('priority');}}
                        >Priority</Table.HeaderCell>
                        <Table.HeaderCell
                            sorted={this.props.sortedColumn === 'info' ? this.props.sortDirection : null}
                            onClick={() => {this.props.changeRuleSort('info');}}
...
export default connect(mapStateToProps, {getMRIRules, changeRuleSort})(RulesTable);