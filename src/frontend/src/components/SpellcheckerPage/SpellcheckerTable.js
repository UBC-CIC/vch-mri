...
import { getSpellcheckWords, changeSpellcheckSort} from "../../actions/SpellcheckActions";
...
export default connect(mapStateToProps, {changeSpellcheckSort, getSpellcheckWords})(SpellcheckerTable);