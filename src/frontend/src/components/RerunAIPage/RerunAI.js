...
import { getRerunAIHistory } from "../../actions/ResultActions";
import { sendErrorToast, sendSuccessToast } from "../../helpers";

class RerunAI extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      startDate: "",
...
export default connect(mapStateToProps, { getRerunAIHistory })(RerunAI);
